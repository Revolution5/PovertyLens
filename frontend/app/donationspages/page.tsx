...
export default function DonationsAndVolunteeringPage(){
    return (
        ...
        >
            ...
            <p style={{width: '100%', fontSize: 32, lineHeight: 1.4, marginTop: 18, color: textBrown, textAlign: 'left'}}>
                We built PovertyLens to make action accessible from anywhere. That means your impact 
                shouldn't be based solely on your zip code. The organizations provided are verified platforms 
                where you donate financially or volunteer hands-on to combat poverty.
            </p>
            </div>
            {/* ---- DONATIONS SECTIONS ---- */}
            <section style={{ display: 'grid', gridTemplateColumns: '1.1fr 2fr', gap: 26, alignItems: 'flex-start', marginTop: 40, marginBottom: 70}}>
            <div>
                <h2
                    style={{
                        fontSize: 60,
                ...
                {/* Left text block */}
                    <p style={{ fontSize: 32, lineHeight: 1.6}}>
                        The organizations shown here are focused on effective, evidence-based giving.
                        These groups ensure your money is making the best possible difference.
                    </p>
                </div>
                {/* Donations Cards */}
                <div
            ...
            >
                ...
                <div>
                    ...
                    <p style={{fontSize: 32, lineHeight: 1.6, marginBottom: 12,}}>
                        We understand that not everyone can commit to on-site or has a local chapter nearby. The organizations to the left specialize in virtual, remote, or skills-based volunteering that you can do from your laptop, anywhere around the world.
                    </p>
                    <p style={{fontSize: 32, lineHeight: 1.6}}>
